...
export const OrderDashboard = () => {
    const { fetchAllOrders, orders } = useAdminStore();
                        ...
                        <div className="flex flex-col gap-1">
                            ...
                            <div className="border-b border-[#595959] py-[10px] w-full flex justify-between">
                                ...
                                <div className='flex rounded-lg bg-[#2B2B2B]'>
                                    <button className={`py-2 px-2 rounded-lg ${detail.status.toLowerCase() !== 'delivered' ? 'bg-[#322A21] text-[#F57C00]' : 'text-[#595959]'}`}>In Progress</button>
                                    <button className={`py-2 px-2 rounded-lg ${detail.status.toLowerCase() == 'delivered' ? 'bg-[#61C45312] text-[#61C453]' : 'text-[#595959]'}`}>Delivered</button>
                                </div>
                            </div>
                        </div>
