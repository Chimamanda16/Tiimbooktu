  ...
  return (
    <section id="fotografie" className="my-[80px] text-center">
      <div className="w-[90%] mx-auto flex flex-col items-center">
        ...
        <Link
          to="/lacomposmentis"
          className="relative block mt-5 font-glacial lg:mt-16 bg-[#cdffad] text-[#1c1c1c] font-normal rounded-[22px] px-4 py-2 cursor-pointer text-lg max-sm:text-base max-sm:px-5 max-sm:py-3"
        >
          View All
        </Link>
      </div>
