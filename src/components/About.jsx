function AboutComp() {
    return (
        <div className="mb-[10%]">
            <h2 className="text-[112px] font-[MyFont] ml-[15%] max-md:text-3xl mb-[2%]">ABOUT TIIMBOOKTU</h2>
            <div className="w-[50%] ml-[30%] max-md:w-fit md:mr-[5%]">
                <p>
                ...
                <button className="bg-[#CDFFAD] border-none rounded-[22px] text-[#1c1c1c] cursor-pointer font-normal px-4 py-2 mt-[2%]">
                    Learn More
                </button>
            </div>
        </div>
