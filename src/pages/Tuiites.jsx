            ...
            >
                <div className="flex flex-col w-full lg:items-center gap-4 lg:gap-8 mb-6">
                    <div className="flex flex-col gap-2">
                        ...
                        <p className="font-cinzel text-xl text-[#D9D9D9]">From our small growing army of friends, fans and fan-atics...on a page solely for them and none else.</p>
                    </div>
                        ...
                        {tuiiteData.map((data, index) => {
                            return <div key={index} className="flex flex-col gap-3">
                                ...
                                <div className="flex flex-col gap-1">
                                    <p className="font-cinzel text-xl uppercase"> {data.desc} </p>
                                    <span className="text-xl font-bold font-cinzel"> {data.location} </span>
                                </div>
                            </div>
                        })}
                    </div>
