...
const Composmentis = () => {
  ...
  const shopData = [
    ...
    {
      id: 3,
      image: "/assets/images/listen.jpeg",
      date: "February 12, 2024",
      ...
      <div className="flex flex-col gap-8 w-[88%] mb-10 lg:mb-[120px] mx-auto">
        <div className="flex flex-col gap-1">
          ...
          <p className="text-center capitalize text-xl">
            I got, like, storey-high piles of shit on my mind every effin’ day
            that I get to tell just me. Now, I get to tell you.{" "}
          </p>
        </div>
              ...
              >
                ...
                <div className="flex flex-col gap-[14px]">
                  <div className="flex flex-col justify-between items-center gap-2">
                    ...
                    <div className="text-[#0A0A0A] text-xl line-clamp-4">
                      {shop.desc}
                    </div>
                  </div>
                </div>
                <Link
                  to={`/blog/${shop.id}`}
                  className="border border-[#0A0A0A] font-bold text-[#0A0A0A] p-[10px] px-4"
                >
                  Read more
                </Link>
              </div>
